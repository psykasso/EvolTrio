...
import gr.evomusic.evoltrio.exception.InvalidConfigurationException;
...
//		durationMap.put("s* ", 0.166666667);
	...
	/**
	 * The keyNote is the root note for a given chromosome.
	 * It's been calculated as the index of the NOTE plus
	 * the octave times NOTES.length.
	 */
	 ...
	 * interval portion. This value is handled by
	 * jgap.
	 */
	...
	/**
	 * The maximum possible jump for a gene in the
	 * duration portion. This value is handled by
	 * jgap.
	 */
	...
	/**
	 * 
	 * @return a integer representing the different possible values
	 * in a scale
	 */
	...
	/**
	 * Updates the the keyNote when rootNote, restOffset or octave
	 * is changed.
	 */
	private void updateKeyNote() {
		keyNote = getNoteIndex(rootNote) + ((NOTES.length + restOffset) * (octave + 1));
	}
	
	/**
	 * Gives the index of the given note as it appears in the NOTES array.
	 * 
	 * @param theNote a given note
	...
	/**
	 * This method splits the musicPattern and sets the 
	 * chordProgression array.
	 * TODO handle errors
	 */
	...
	/**
	 * @param rootNote the rootNote to set
	 */
	...
	/**
	 * @param musicPattern the musicPattern to set
	 */
	...
	/**
	 * @param beginningDuration the beginningDuration to set
	 */
	public void setBeginningDuration(int beginningDuration) {
		if (beginningDuration < 1 || beginningDuration > 6){
			System.out.println("MusicConfiguration: Invalid beginning duration value :" + 
	...
	/**
	 * @param phraseNotes the phraseNotes to set
	 */
	public void setPhraseNotes(int phraseNotes) {
		if (phraseNotes < 4 || phraseNotes > 32){
			System.out.println("MusicConfiguration: Invalid phrase notes value :" + 
	...
	/**
	 * @param maxIntervalJump the maxIntervalJump to set
	 * TODO check weather changing this according to the restOffset is needed
	 */
	public void setMaxIntervalJump(int maxIntervalJump) {
		if (maxIntervalJump < 1 || maxIntervalJump > 12){
			System.out.println("MusicConfiguration: Invalid maxIntevalJump value :" + 
	...
	/**
	 * @param maxDurationJump the maxDurationJump to set
	 */
	public void setMaxDurationJump(int maxDurationJump) {
		if (maxDurationJump < 1 || maxDurationJump > 6){
			System.out.println("MusicConfiguration: Invalid maxDurationJump value :" + 
	...
	/**
	 * @param bassPattern the bassPattern to set
	 */
	...
	/**
	 * @param drumPattern the drumPattern to set
	 */
	...
	/**
	 * @param soloOrgan the soloOrgan to set
	 */
	public void setSoloOrgan(int soloOrgan) {
		if (soloOrgan < 0 || soloOrgan > 127){
			System.out.println("MusicConfiguration: Invalid solo organ value :" + 
					maxDurationJump + ". Setting to default (75). \n" +
